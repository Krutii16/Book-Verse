    ...
    <div class="min-h-screen bg-gray-50 py-12 px-4">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div *ngFor="let mood of moods" [routerLink]="['/books']" [queryParams]="{ moods: mood.name }" class="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition cursor-pointer text-center">
